export declare namespace DDSEncoder {
    type DxtType = 'DXT1' | 'DXT2' | 'DXT3' | 'DXT4' | 'DXT5' | 'DX10';
    enum DDSDwFlag {
        DDSD_CAPS = 1,
        DDSD_HEIGHT = 2,
        DDSD_WIDTH = 4,
    ...
    class DDSData {
         ...
         */
        static fromData(data: Uint8Array, width: number, height: number, dxt?: DxtType): DDSData;
    }
}
